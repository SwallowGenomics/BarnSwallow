...
#panel E
CMplot(acc_CM1_abs, type = "p", plot.type = "m", LOG10 = FALSE, col=col_all, lwd.axis=3, cex.axis=4,cex.lab=5,ylab.pos=4.5,xticks.pos=3,chr.labels.angle=45, amplify=TRUE, threshold=9.295875, threshold.col="black", threshold.lwd=4, threshold.lty=1, band=0.5, memo= "panelE", dpi=600,  file = "jpg", file.output=TRUE, verbose = TRUE, width = 70, height = 20, mar=c(10,10,6,6))

#panel F
CMplot(cons_CM1, type = "p", plot.type = "m", ylim=c(2.69,3.6), LOG10 = FALSE, col=col_all, lwd.axis=3, cex.axis=4,cex.lab=5,ylab.pos=6,xticks.pos=3,chr.labels.angle=45, amplify=TRUE, band=0.5, memo= "panelF", dpi=600,  file = "jpg", file.output=TRUE, verbose = TRUE, width = 70, height = 20, mar=c(10,11,6,6))

#panel B
pdf("panelB.pdf", width = 9, height = 5)
...
pdf("panelD.pdf", width = 7, height = 5)
